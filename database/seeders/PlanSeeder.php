...
class PlanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('plan_feature')->insert([
            ...
            ['plan_id' => 2, 'feature_id' => 1, 'feature_value' => 1],
            ['plan_id' => 2, 'feature_id' => 2, 'feature_value' => 1],
            ['plan_id' => 3, 'feature_id' => 1, 'feature_value' => 1],
            ['plan_id' => 3, 'feature_id' => 2, 'feature_value' => 1],
        ]);
    }
}
